...
>(({ bg_hover, text, className, ...props }, ref) => {

  return (
    <button
      ref={ref}
      className={cn(
        "group relative w-32 cursor-pointer overflow-hidden rounded-xl border bg-background p-2 text-center font-semibold flex justify-center",
        className,
      )}
      {...props}
    >
