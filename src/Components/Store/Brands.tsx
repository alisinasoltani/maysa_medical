...
const Brands = () => {
  return (
    <div className="flex justify-center items-center px-[6rem] pt-[4rem] pb-[6rem]">
        <div className="flex flex-col md:flex-row justify-center items-stretch gap-0 shadow-lg rounded-3xl">
            ...
            style={{ direction: 'rtl' }}>
                ...
                <h3 className="pt-8 iransans_med text-xl">کآرومد</h3>
            ...
            style={{ direction: 'rtl' }}>
                ...
                <h3 className="pt-8 iransans_med text-xl">بکر</h3>
